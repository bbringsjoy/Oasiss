        ...
        <div class="login">
            ...
            <form name="form1" method="POST" data-parsley-validate="">
                ...
                <br>
                 ...
                 <label for="tipo_perfil">Tipo do perfil:</label>
                    <select name="tipo_perfil" id="tipo_perfil" class="form-control" required data-parsley-required-message="Selecione uma opção">
                        <option value=""></option>
                        <option value="Adm">Locador</option>
...
<div class="input-group mb-3 **input-senha-custom**"> <input type="password" class="form-control" name="senha" id="senha"
    ...
    <div class="input-group mb-3 **input-senha-custom**"> 
        <input type="password" class="form-control" name="senha" id="senha"
        placeholder="Digite sua senha" required
        data-parsley-required-message="Digite novamente a senha"
        data-parsley-errors-container="#erro">
    ...
    <button class="btn btn-outline-secondary" type="button" id="togglePassword">
        <i class="fas fa-eye" id="toggleIcon"></i>
                ...
                <button type="submit" class="btn btn-success w-100">
                    <i class="fas fa-check"></i> Cadastre-se
                </button>


                <div class="cadastro" style="text-align:center">
                    <p>Já tem uma conta? <a class="cadastrese" href="login.php">Faça login aqui!</a></p>
                </div>
